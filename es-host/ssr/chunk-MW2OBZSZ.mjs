...
var EnumTimeout;
(function(EnumTimeout2) {
  EnumTimeout2[EnumTimeout2["Short"] = Config.Basic.defaultToastTimeout] = "Short";
  EnumTimeout2[EnumTimeout2["Long"] = 2e4] = "Long";
  EnumTimeout2[EnumTimeout2["Never"] = -1] = "Never";
})(EnumTimeout || (EnumTimeout = {}));

// src/app/lib/toast/toast.partial.ts
function ToastPartialComponent_ng_container_0_div_3_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 5);
    \u0275\u0275listener("click", function ToastPartialComponent_ng_container_0_div_3_button_1_Template_button_click_0_listener($event) {
      const button_r4 = \u0275\u0275restoreView(_r3).$implicit;
      return \u0275\u0275resetView(button_r4?.click($event));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275classMap(button_r4.css);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(button_r4.text);
  }
}
function ToastPartialComponent_ng_container_0_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3);
    \u0275\u0275template(1, ToastPartialComponent_ng_container_0_div_3_button_1_Template, 2, 3, "button", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const toast_r2 = \u0275\u0275nextContext().ngIf;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", toast_r2.buttons);
  }
}
function ToastPartialComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ToastPartialComponent_ng_container_0_Template_div_click_2_listener($event) {
      const toast_r2 = \u0275\u0275restoreView(_r1).ngIf;
      return \u0275\u0275resetView(toast_r2.clickable && toast_r2.clickable($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ToastPartialComponent_ng_container_0_div_3_Template, 2, 1, "div", 2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const toast_r2 = ctx.ngIf;
    \u0275\u0275advance();
    \u0275\u0275classMap(\u0275\u0275interpolate2("", toast_r2.css, " ", toast_r2.extracss));
    \u0275\u0275classProp("inview", toast_r2.visible);
    \u0275\u0275advance();
    \u0275\u0275property("innerHtml", toast_r2.text, \u0275\u0275sanitizeHtml);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", toast_r2.buttons?.length);
  }
}
var ToastPartialComponent = class _ToastPartialComponent {
  toastState;
  constructor(toastState) {
    this.toastState = toastState;
  }
  static \u0275fac = function ToastPartialComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ToastPartialComponent)(\u0275\u0275directiveInject(Toast));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToastPartialComponent, selectors: [["sh-toast"]], decls: 2, vars: 3, consts: [[4, "ngIf"], [1, "text", 3, "click", "innerHtml"], ["class", "buttons", 4, "ngIf"], [1, "buttons"], [3, "class", "click", 4, "ngFor", "ngForOf"], [3, "click"]], template: function ToastPartialComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, ToastPartialComponent_ng_container_0_Template, 4, 8, "ng-container", 0);
      \u0275\u0275pipe(1, "async");
    }
    if (rf & 2) {
      \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(1, 1, ctx.toastState.stateItem$));
    }
  }, dependencies: [CommonModule, NgForOf, NgIf, AsyncPipe], styles: [".toast[_ngcontent-%COMP%]{display:flex;flex-wrap:nowrap;align-items:center;background-color:#263238;color:#fff;position:fixed;bottom:1.6rem;left:1.6rem;right:1.6rem;font-size:90%;z-index:5100;box-shadow:0 6px 10px #00000024,0 1px 18px #0000001f,0 3px 5px -1px #0000004d;transform:translateY(calc(100% + 1.6rem));transition:transform .2s ease-in-out}.toast.error[_ngcontent-%COMP%]{background-color:#f31109}.toast.success[_ngcontent-%COMP%]{background-color:#57b347}.toast.warning[_ngcontent-%COMP%]{background-color:#ffc400;color:#202020}.toast.inview[_ngcontent-%COMP%]{transform:translateY(0)}.text[_ngcontent-%COMP%]{padding:1.6rem;margin-right:.8rem;flex-basis:100%}.buttons[_ngcontent-%COMP%]{display:flex}.buttons[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{text-transform:uppercase;padding:1.6rem;cursor:pointer;color:inherit;display:block}@media only screen and (min-width:720px){.toast[_ngcontent-%COMP%]{max-width:50vw}}"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToastPartialComponent, [{
    type: Component,
    args: [{ selector: "sh-toast", imports: [CommonModule], template: `
    ...
    `, changeDetection: ChangeDetectionStrategy.OnPush, styles: [".toast{display:flex;flex-wrap:nowrap;align-items:center;background-color:#263238;color:#fff;position:fixed;bottom:1.6rem;left:1.6rem;right:1.6rem;font-size:90%;z-index:5100;box-shadow:0 6px 10px #00000024,0 1px 18px #0000001f,0 3px 5px -1px #0000004d;transform:translateY(calc(100% + 1.6rem));transition:transform .2s ease-in-out}.toast.error{background-color:#f31109}.toast.success{background-color:#57b347}.toast.warning{background-color:#ffc400;color:#202020}.toast.inview{transform:translateY(0)}.text{padding:1.6rem;margin-right:.8rem;flex-basis:100%}.buttons{display:flex}.buttons button{text-transform:uppercase;padding:1.6rem;cursor:pointer;color:inherit;display:block}@media only screen and (min-width:720px){.toast{max-width:50vw}}\n"] }]
  }], () => [{ type: Toast }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ToastPartialComponent, { className: "ToastPartialComponent", filePath: "src/app/lib/toast/toast.partial.ts", lineNumber: 25 });
})();

// src/app/lib/toast/toast.state.ts
var Toast = class _Toast extends StateService {
  appRef;
  //
  ...
  addComponent() {
    ...
    document.body.append(componentRef.hostView.rootNodes[0]);
    this.created = true;
  }
  dismissButton = {
    css: "btn-close",
  ...
  constructor(appRef) {
    super();
    this.appRef = appRef;
    this.SetState(__spreadValues({}, this.defaultOptions));
  }
  Show(code, options) {
    if (!this.created) {
      this.addComponent();
    ...
    this.Hide();
    const _options = __spreadValues(__spreadValues({}, this.defaultOptions), options);
    const message = Res.Get(code, options?.text || Res.Get("Unknown"));
    timer(100).subscribe(() => {
      this.SetState(__spreadProps(__spreadValues({}, _options), { text: message, visible: true }));
    });
  ...
  ShowError(code, options) {
    this.Show(code, __spreadValues({ extracss: "error" }, options));
  }
  ShowSuccess(code, options) {
    this.Show(code, __spreadValues({ extracss: "success" }, options));
  }
  ShowWarning(code, options) {
    this.Show(code, __spreadValues({ extracss: "warning" }, options));
  }
  Hide() {
    if (this.isCanceled) {
  ...
  static \u0275fac = function Toast_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Toast)(\u0275\u0275inject(ApplicationRef));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _Toast, factory: _Toast.\u0275fac, providedIn: "root" });
};
(() => {
