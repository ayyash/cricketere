...
async function PreRender({ indexFile, clientPath, serverBundlePath, route, language, localePath }) {
    const result = {};
    ...
    await Promise.resolve().then(() => require(languagePath));
    ...
    const { renderModule, AppServerModule } = await Promise.resolve().then(() => require(serverBundlePath));
